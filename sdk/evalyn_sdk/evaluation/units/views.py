...
def _project_tool_use(unit: EvalUnit, call: FunctionCall) -> EvalView:
    ...
    if tool_result_span:
        output_data = tool_result_span.attributes.get("result") or tool_result_span.attributes.get(
            "output"
        )
    elif tool_call_span:
        output_data = tool_call_span.attributes.get("result") or tool_call_span.attributes.get(
            "output"
        )
    else:
        output_data = None
