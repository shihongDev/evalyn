"""
Clustering module for semantic grouping of LLM judge vs human disagreements.

Uses LLM-based clustering to group misalignment reasons by semantic similarity,
