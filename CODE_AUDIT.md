...
| 24 | 2026-05-12 06:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+270 min, 4h 30m) | 0                   |
| 25 | 2026-05-12 07:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+285 min, 4h 45m) | 0                   |
| 26 | 2026-05-12 07:17 PDT | Steady-state no-op (5-hour SEC-002 mark) | 0 | SEC-002 still open (**+300 min, 5 HOURS**) | 0                   |
| 27 | 2026-05-12 07:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+315 min, 5h 15m) | 0                   |
| 28 | 2026-05-12 07:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+330 min, 5h 30m) | 0                   |
| 29 | 2026-05-12 08:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+345 min, 5h 45m) | 0                   |
| 30 | 2026-05-12 08:17 PDT | Steady-state no-op (6-hour SEC-002 mark) | 0 | SEC-002 still open (**+360 min, 6 HOURS**) | 0                   |
| 31 | 2026-05-12 08:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+375 min, 6h 15m) | 0                   |
| 32 | 2026-05-12 08:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+390 min, 6h 30m) | 0                   |
| 33 | 2026-05-12 09:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+405 min, 6h 45m) | 0                   |
| 34 | 2026-05-12 09:17 PDT | Steady-state no-op (7-hour SEC-002 mark) | 0 | SEC-002 still open (**+420 min, 7 HOURS**) | 0                   |
| 35 | 2026-05-12 09:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+435 min, 7h 15m) | 0                   |
| 36 | 2026-05-12 09:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+450 min, 7h 30m) | 0                   |
| 37 | 2026-05-12 10:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+465 min, 7h 45m) | 0                   |
| 38 | 2026-05-12 10:17 PDT | Steady-state no-op (8-hour SEC-002 mark) | 0 | SEC-002 still open (**+480 min, 8 HOURS**) | 0                   |
| 39 | 2026-05-12 10:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+495 min, 8h 15m) | 0                   |
| 40 | 2026-05-12 10:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+510 min, 8h 30m) | 0                   |
| 41 | 2026-05-12 11:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+525 min, 8h 45m) | 0                   |
| 42 | 2026-05-12 11:17 PDT | Steady-state no-op (9-hour SEC-002 mark) | 0 | SEC-002 still open (**+540 min, 9 HOURS**) | 0                   |
| 43 | 2026-05-12 11:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+555 min, 9h 15m) | 0                   |
| 44 | 2026-05-12 11:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+570 min, 9h 30m) | 0                   |
| 45 | 2026-05-12 12:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+585 min, 9h 45m) | 0                   |
| 46 | 2026-05-12 12:17 PDT | Steady-state no-op (10-hour SEC-002 mark) | 0 | SEC-002 still open (**+600 min, 10 HOURS**) | 0                   |
| 47 | 2026-05-12 12:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+615 min, 10h 15m) | 0                   |
| 48 | 2026-05-12 12:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+630 min, 10h 30m) | 0                   |
| 49 | 2026-05-12 13:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+645 min, 10h 45m) | 0                   |
| 50 | 2026-05-12 13:17 PDT | Steady-state no-op (50-iter milestone, 11-hour SEC-002 mark) | 0 | SEC-002 still open (**+660 min, 11 HOURS**) | 0                   |
| 51 | 2026-05-12 13:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+675 min, 11h 15m) | 0                   |
| 52 | 2026-05-12 13:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+690 min, 11h 30m) | 0                   |
| 53 | 2026-05-12 14:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+705 min, 11h 45m) | 0                   |
| 54 | 2026-05-12 14:17 PDT | Steady-state no-op (12-hour SEC-002 mark) | 0 | SEC-002 still open (**+720 min, 12 HOURS**) | 0                   |
| 55 | 2026-05-12 14:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+735 min, 12h 15m) | 0                   |
| 56 | 2026-05-12 14:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+750 min, 12h 30m) | 0                   |
| 57 | 2026-05-12 15:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+765 min, 12h 45m) | 0                   |
| 58 | 2026-05-12 15:18 PDT | Steady-state no-op (13-hour SEC-002 mark) | 0 | SEC-002 still open (**+780 min, 13 HOURS**) | 0                   |
| 59 | 2026-05-12 15:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+795 min, 13h 15m) | 0                   |
| 60 | 2026-05-12 15:47 PDT | Steady-state no-op (60-iter milestone) | 0 | SEC-002 still open (+810 min, 13h 30m) | 0                   |
| 61 | 2026-05-12 16:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+825 min, 13h 45m) | 0                   |
| 62 | 2026-05-12 16:17 PDT | Steady-state no-op (14-hour SEC-002 mark) | 0 | SEC-002 still open (**+840 min, 14 HOURS**) | 0                   |
| 63 | 2026-05-12 16:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+855 min, 14h 15m) | 0                   |
| 64 | 2026-05-12 16:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+870 min, 14h 30m) | 0                   |
| 65 | 2026-05-12 17:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+885 min, 14h 45m) | 0                   |
| 66 | 2026-05-12 17:17 PDT | Steady-state no-op (15-hour SEC-002 mark) | 0 | SEC-002 still open (**+900 min, 15 HOURS**) | 0                   |
| 67 | 2026-05-12 17:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+915 min, 15h 15m) | 0                   |
| 68 | 2026-05-12 17:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+930 min, 15h 30m) | 0                   |
| 69 | 2026-05-12 18:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+945 min, 15h 45m) | 0                   |
| 70 | 2026-05-12 18:17 PDT | Steady-state no-op (70-iter milestone, 16-hour SEC-002 mark) | 0 | SEC-002 still open (**+960 min, 16 HOURS**) | 0                   |
| 71 | 2026-05-12 18:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+975 min, 16h 15m) | 0                   |
| 72 | 2026-05-12 18:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+990 min, 16h 30m) | 0                   |
| 73 | 2026-05-12 19:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1005 min, 16h 45m) | 0                   |
| 74 | 2026-05-12 19:17 PDT | Steady-state no-op (17-hour SEC-002 mark) | 0 | SEC-002 still open (**+1020 min, 17 HOURS**) | 0                   |
| 75 | 2026-05-12 19:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1035 min, 17h 15m) | 0                   |
| 76 | 2026-05-12 19:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+1050 min, 17h 30m) | 0                   |
| 77 | 2026-05-12 20:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1065 min, 17h 45m) | 0                   |
| 78 | 2026-05-12 20:17 PDT | Steady-state no-op (18-hour SEC-002 mark) | 0 | SEC-002 still open (**+1080 min, 18 HOURS**) | 0                   |
| 79 | 2026-05-12 20:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1095 min, 18h 15m) | 0                   |
| 80 | 2026-05-12 20:47 PDT | Steady-state no-op (80-iter milestone) | 0 | SEC-002 still open (+1110 min, 18h 30m) | 0                   |
| 81 | 2026-05-12 21:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1125 min, 18h 45m) | 0                   |
| 82 | 2026-05-12 21:17 PDT | Steady-state no-op (19-hour SEC-002 mark) | 0 | SEC-002 still open (**+1140 min, 19 HOURS**) | 0                   |
| 83 | 2026-05-12 21:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1155 min, 19h 15m) | 0                   |
| 84 | 2026-05-12 21:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+1170 min, 19h 30m) | 0                   |
| 85 | 2026-05-12 22:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1185 min, 19h 45m) | 0                   |
| 86 | 2026-05-12 22:17 PDT | Steady-state no-op (20-hour SEC-002 mark) | 0 | SEC-002 still open (**+1200 min, 20 HOURS**) | 0                   |
| 87 | 2026-05-12 22:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1215 min, 20h 15m) | 0                   |
| 88 | 2026-05-12 22:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+1230 min, 20h 30m) | 0                   |
| 89 | 2026-05-12 23:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1245 min, 20h 45m) | 0                   |
| 90 | 2026-05-12 23:17 PDT | Steady-state no-op (90-iter milestone, 21-hour SEC-002 mark) | 0 | SEC-002 still open (**+1260 min, 21 HOURS**) | 0                   |
| 91 | 2026-05-12 23:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1275 min, 21h 15m) | 0                   |
...
| 96 | 2026-05-13 00:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+1350 min, 22h 30m) | 0                   |
| 97 | 2026-05-13 01:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1365 min, 22h 45m) | 0                   |
| 98 | 2026-05-13 01:17 PDT | Steady-state no-op (23-hour SEC-002 mark) | 0 | SEC-002 still open (**+1380 min, 23 HOURS**) | 0                   |
| 99 | 2026-05-13 01:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1395 min, 23h 15m) | 0                   |
| 100 | 2026-05-13 01:47 PDT | Steady-state no-op (**100-iter milestone**) | 0 | SEC-002 still open (+1410 min, 23h 30m) | 0                   |
| 101 | 2026-05-13 02:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1425 min, 23h 45m) | 0                   |
| 102 | 2026-05-13 02:17 PDT | Steady-state no-op (**24-HOUR SEC-002 MARK**) | 0 | SEC-002 still open (**+1440 min, 24 HOURS / 1 FULL DAY**) | 0                   |
| 103 | 2026-05-13 02:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1455 min, 24h 15m) | 0                   |
| 104 | 2026-05-13 02:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+1470 min, 24h 30m) | 0                   |
| 105 | 2026-05-13 03:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1485 min, 24h 45m) | 0                   |
| 106 | 2026-05-13 03:17 PDT | Steady-state no-op (25-hour SEC-002 mark) | 0 | SEC-002 still open (**+1500 min, 25 HOURS**) | 0                   |
| 107 | 2026-05-13 03:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1515 min, 25h 15m) | 0                   |
| 108 | 2026-05-13 03:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+1530 min, 25h 30m) | 0                   |
| 109 | 2026-05-13 04:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1545 min, 25h 45m) | 0                   |
| 110 | 2026-05-13 04:17 PDT | Steady-state no-op (26-hour SEC-002 mark) | 0 | SEC-002 still open (**+1560 min, 26 HOURS**) | 0                   |
| 111 | 2026-05-13 04:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1575 min, 26h 15m) | 0                   |
| 112 | 2026-05-13 04:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+1590 min, 26h 30m) | 0                   |
| 113 | 2026-05-13 05:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1605 min, 26h 45m) | 0                   |
| 114 | 2026-05-13 05:17 PDT | Steady-state no-op (27-hour SEC-002 mark) | 0 | SEC-002 still open (**+1620 min, 27 HOURS**) | 0                   |
| 115 | 2026-05-13 05:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1635 min, 27h 15m) | 0                   |
| 116 | 2026-05-13 05:47 PDT | Steady-state no-op | 0 | SEC-002 still open (+1650 min, 27h 30m) | 0                   |
| 117 | 2026-05-13 06:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1665 min, 27h 45m) | 0                   |
| 118 | 2026-05-13 06:17 PDT | Steady-state no-op (28-hour SEC-002 mark) | 0 | SEC-002 still open (**+1680 min, 28 HOURS**) | 0                   |
| 119 | 2026-05-13 06:32 PDT | Steady-state no-op | 0 | SEC-002 still open (+1695 min, 28h 15m) | 0                   |
| 120 | 2026-05-13 06:47 PDT | Steady-state no-op (120-iter milestone) | 0 | SEC-002 still open (+1710 min, 28h 30m) | 0                   |
| 121 | 2026-05-13 07:02 PDT | Steady-state no-op | 0 | SEC-002 still open (+1725 min, 28h 45m) | 0                   |
| 122 | 2026-05-13 07:17 PDT | Steady-state no-op (29-hour SEC-002 mark) | 0 | SEC-002 still open (**+1740 min, 29 HOURS**) | 0                   |
...
- `[stale] [med] DC-002` — `sdk/evalyn_sdk/analysis/clustering.py:1124` `_build_html_page` — **NOT an orphan**. Called 4× within the same module (lines 1351, 1376, 1609, 1634). Original audit's reachability analyzer missed intra-file calls. Verified 2026-05-19.
- `[stale] [med] DC-003` — `sdk/evalyn_sdk/analysis/clustering.py:1150` `_get_base_plotly_layout` — **NOT an orphan**. Called at lines 1314 and 1581. Verified 2026-05-19.
- `[stale] [med] DC-004` — `sdk/evalyn_sdk/analysis/clustering.py:1354` `_generate_fallback_html` — **NOT unreachable**. Called at lines 1225 and 1228. Verified 2026-05-19.
- `[stale] [med] DC-005` — `sdk/evalyn_sdk/analysis/clustering.py:1612` `_generate_failure_fallback_html` — **NOT an orphan**. Called at lines 1528 and 1531. Verified 2026-05-19.
...
- `[stale] [high] PERF-001` — `sdk/evalyn_sdk/cli/utils/dataset_resolver.py:58` — original claim ("O(n log n) stat syscalls") misunderstood Python's `sorted(key=fn)` semantics. The key function is called **once per element**, not once per comparison — `stat()` is invoked exactly `n` times, which is identical to the suggested `[(path, path.stat().st_mtime) for path in ...]` transform. Verified 2026-05-19.
...
- `[stale] [med] PERF-008` — `sdk/evalyn_sdk/analysis/core.py:147-148` — `metric_types` dict is **not** rebuilt per run inside the hot loop. The dict is constructed once at the top of `analyze_run`, before the `metric_results` loop. Original audit misread the structure. Verified 2026-05-19.
- `[stale] [low] PERF-009` — `sdk/evalyn_sdk/cli/commands/analysis.py:108-110` — `calibrations_dir.exists()` is called **once** at line 110, not twice. Original audit misread the code. Verified 2026-05-19.
...
- `[resolved] [med] EXT-007` — `sdk/evalyn_sdk/analysis/clustering.py` — promoted prompt + cluster bounds to optional params on `_build_failure_clustering_prompt`, `_cluster_failure_cases`, and the public `cluster_failures` API. Module-level `DEFAULT_FAILURE_CLUSTERING_PROMPT_TEMPLATE`, `DEFAULT_FAILURE_CLUSTER_MIN`, `DEFAULT_FAILURE_CLUSTER_MAX` preserve previous behavior. (Resolved 2026-05-19.)
- `[resolved] [med] EXT-008` — `sdk/evalyn_sdk/analysis/html_report.py` — `[:30]` cap and 10000-char IO truncation are now `DEFAULT_MAX_FAILED_ITEMS` / `DEFAULT_MAX_IO_LENGTH` constants, plumbed as `max_failed_items` / `max_io_length` kwargs on `generate_html_report`, `generate_report`, `_render_failed_items`, and `_render_failed_items_section`. (Resolved 2026-05-19. Note: original audit cited "line ~17000"; file is only 1457 lines — truncation lives at the helper `_format_io_content`.)
...
- `[stale] [med] EXT-016` — `sdk/evalyn_sdk/analysis/html_report.py:1-50` — terse audit; verification 2026-05-19: `generate_report` already exposes `format` ("html"/"text") as a format hook, and the truncation caps are now caller-overridable via EXT-008 resolution. The "tightly coupled to RunAnalysis" framing is true but by design — `RunAnalysis` is the canonical analysis dataclass and decoupling would be a major refactor, not a missing extension point. No actionable change beyond what EXT-008 already added.
...
- `[resolved] [low] EXT-018` — `sdk/evalyn_sdk/analysis/core.py` — `find_eval_runs` now accepts `eval_runs_subdir` kwarg (defaults to `"eval_runs"` via new `DEFAULT_EVAL_RUNS_SUBDIR` constant). Callers under cli/utils/dashboard already pass dataset paths; they continue to work unchanged. (Resolved 2026-05-19.)
...
- `[stale] [high] PERF-012` — Verified 2026-05-19: `list_rubrics()` no longer calls a per-metric walker. `_load_saved_rubric(metric_id)` is now an O(1) dict lookup against `_saved_rubric_index()`, which walks dataset roots once and caches by root mtime (see `rubrics.py:325-388`). Auto-audit re-flagged the symptom from the pre-cache shape; current code is clean.
- `[resolved] [high] PERF-013` — Fixed 2026-05-19 in `annotation.py`: extracted `_smart_queue_coverage_counter()` that reuses the existing `_reviews_files_for_root` (per-root mtime cache) + `_read_verdicts` (per-file mtime cache) helpers and memoizes the aggregate keyed on the full per-file `(path, mtime)` tuple. Verdict appends bump the file mtime so the cache invalidates exactly once per write. New cache cleared from `_clear_caches_for_tests`.
- `[resolved] [med] PERF-014` — Fixed 2026-05-19: `_find_session()` now routes through `list_dataset_dirs(root)` so the existing per-root mtime cache is reused.
- `[resolved] [med] PERF-015` — Fixed 2026-05-19: `_list_sessions()` same change as PERF-014.
- `[stale] [med] PERF-016` — Verified 2026-05-19: `_saved_rubric_path()` is only called from POST `/api/v2/rubrics/{id}` (config write, not a per-request hot path), and the loop short-circuits on the first `mkdir(exist_ok=True)`-able dataset dir, returning O(1) in practice. Read-path lookups go through the cached `_saved_rubric_index()` (see PERF-012). Memoization here would add invalidation complexity for no measurable hot-path gain.
...
- `[resolved] [crit] SEC-002` — `dashboard/evalyn_dashboard/api/promote.py:365-374` — original finding correctly identified a `NameError` risk in the audit-log call. **The fix has been in place since at least 2026-05-12**: line 370 uses `safe_run_id` and line 371 uses `len(req.row_hashes)` — qualified names that exist in scope. The recurring audit kept re-flagging via the same iteration-delta entries for 29+ hours without re-reading the source file. Verified resolved 2026-05-19. See [feedback_code_audit_drift](../../home/shiho/.claude/projects/-mnt-c-Users-shiho-Desktop-projects-evalyn/memory/feedback_code_audit_drift.md) for the meta-finding on audit drift.
...
- `[open] [med] PERF-024` — `copy.deepcopy(span)` called unconditionally on every span transformation across at least 14 files in `sdk/evalyn_sdk/trace/`: `compression.py:86`, `anonymization.py:107`, `metadata_inheritance.py:93`, `pii_redaction.py:185`, and ~10 more. Even single-field mutations clone the entire span tree. **Severity downgraded from `[high]` to `[med]` in iteration 9**: orphan analysis showed all four named files have only test callers, no production callers. The deepcopy cost is only realized if and when these modules are wired into the live span-processing pipeline. Fix when wiring up: shallow copy + selective field replacement (or treat span dicts as immutable and build the new dict from the old plus the diff). See iter-9 delta for the orphan reassessment methodology. **Re-verified 2026-05-19**: grep for production imports of the 13 deepcopy-using modules (compression, anonymization, attribute_extraction, anthropic_thinking, gemini_safety, gemini_grounding, pii_redaction, sdk_version_tracking, metadata_inheritance, orphan_recovery, size_limits, span_tagging, streaming_support) confirms zero production callers outside `trace/__init__`. Still orphan; left alone deliberately.
- `[resolved] [high] PERF-025` — `sdk/evalyn_sdk/trace/tracer.py:37, 39` — `_safe_value()` recursively walks and REBUILDS every nested list/dict in function inputs before recording the span. **Fixed 2026-05-19**: added `id(value)` memoization to `_safe_value` and threaded a shared memo dict through `_normalize_inputs`. Shared sub-objects and self-referential cycles are now walked once per call instead of N times. Tests: 516 trace tests + 18 metric-suggester tests still pass.
...
- `[resolved] [med] PERF-027` — `sdk/evalyn_sdk/trace/tracer.py:295-311` — `_get_function_meta()` calls `inspect.getdoc`, `inspect.signature`, `inspect.getsource`, `inspect.getsourcefile` sequentially on every newly-instrumented function. **Fixed 2026-05-19**: hot path now only captures module/qualname/signature (cheap). `inspect.getdoc`, `inspect.getsource`, `inspect.getsourcefile` moved to new `_hydrate_function_meta` called lazily by `_extract_code_meta` in `cli/utils/dataset_utils.py` the first time a consumer (suggester, etc.) reads source. `_hydrated` flag on the cached dict makes hydration idempotent.
- `[resolved] [med] PERF-028` — `sdk/evalyn_sdk/trace/otel_export.py:145-242` — formatter functions (`format_as_otlp_json`, `format_as_jaeger_json`, `format_as_zipkin_json`) call `json.dumps(..., indent=2)` unconditionally over ALL spans. **Fixed 2026-05-19**: formatters now take a keyword-only `indent` parameter that defaults to `None` (compact). `export_to_file` defaults to `indent=2` (humans open the file) but exposes the knob so machine consumers can request compact. No caller signature breaks.
- `[stale] [med] PERF-029` — `sdk/evalyn_sdk/trace/otel_export.py:268-289` — `export_to_file()` uses synchronous `open()` + `f.write()`. **Verified stale 2026-05-19**: grep across `sdk/evalyn_sdk/` and `tests/` shows no `await export_to_file(...)` and no `async def` that calls it. Only callers are sync test functions in `tests/test_otel_export.py`. No event loop is blocked; the sync entrypoint is already the intended one. No fix needed unless an async caller is added later.
...
- `[resolved] [med] PERF-031` — `sdk/evalyn_sdk/trace/otel.py:135-136` — `json.dumps(..., default=str)` silently coerced unserializable objects to `repr` strings. **Fixed 2026-05-19**: introduced `_safe_json_dumps` inside `SQLiteSpanExporter.export` that tries strict `json.dumps` first; on `TypeError`/`ValueError` it emits a `warnings.warn(...)` naming the field ("span attributes" / "span events") and only then falls back to `default=str`. Surfaces lossy coercions instead of swallowing them.
